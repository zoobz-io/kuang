...
func listRepos(svc *service) rocco.Endpoint {
	...
	}).WithSummary("List repositories").WithTags("github").WithScopes(ScopeReposRead)
}
...
func getRepo(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Get repository").WithTags("github").WithPathParams("name").WithScopes(ScopeReposRead)
}
...
func listIssues(svc *service) rocco.Endpoint {
	...
	}).WithSummary("List issues").WithTags("github").WithPathParams("repo").WithScopes(ScopeIssuesRead)
}
...
func getIssue(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Get issue").WithTags("github").WithPathParams("repo", "number").WithScopes(ScopeIssuesRead)
}
...
func createIssue(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Create issue").WithTags("github").WithPathParams("repo").WithScopes(ScopeIssuesWrite)
}
...
func listPRs(svc *service) rocco.Endpoint {
	...
	}).WithSummary("List pull requests").WithTags("github").WithPathParams("repo").WithScopes(ScopePullsRead)
}
...
func getPR(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Get pull request").WithTags("github").WithPathParams("repo", "number").WithScopes(ScopePullsRead)
}
...
func createPR(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Create pull request").WithTags("github").WithPathParams("repo").WithScopes(ScopePullsWrite)
}
...
func getFile(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Get file content").WithTags("github").WithPathParams("repo", "path...").WithQueryParams("ref").WithScopes(ScopeContentRead)
}
...
func createOrUpdateFile(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Create or update file").WithTags("github").WithPathParams("repo", "path...").WithScopes(ScopeContentWrite)
}
...
func searchCode(svc *service) rocco.Endpoint {
	...
	}).WithSummary("Search code").WithTags("github").WithQueryParams("query").WithScopes(ScopeSearchRead)
}
