...
// newTestServer registers paths and returns the test server.
...
func TestParseInvites(t *testing.T) {
	...
	byRoom := map[string]models.Invite{}
...
func TestResolveRoomByID(t *testing.T) {
	svc := &API{homeserver: "https://matrix.localhost"}
...
func TestServerName(t *testing.T) {
	svc := &API{homeserver: "https://matrix.example.com:8448"}
...
func TestServerNamePlain(t *testing.T) {
	svc := &API{homeserver: "https://localhost"}
